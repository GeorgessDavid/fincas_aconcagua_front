...
export default function Parcela({ className, metrosCuadrados, numero, forma, status, fraccion, rightSector, onClick, isSelected = false }: ParcelaProps) {
    ...
    const formaClasses = forma === 'rectangle' ? 'w-full md:py-3 xl:py-0.5 2xl:py-2' : 'w-full h-full xl:h-full 2xl:h-fit lg:py-8 ';
    const flexProperties = forma === 'square' ? 'flex-col items-center justify-center' : 'flex py-[0.325rem] items-center justify-center gap-2 lg:flex-row lg:items-center lg:justify-evenly';
